...
RocketChat.models.QuestionBase = new Mongo.Collection('questionBase');
RocketChat.models.QuestionBase.allow({
...
Template.room.helpers({
	...
	expertAddress() {
		...
		RocketChat.models.QuestionBase.insert({ room: 'room1', expertAddress: '2223333444' });

		return 'ExpertAddress: ' + RocketChat.models.QuestionBase.find({ name: 'room1' }).fetch();
	},
